#!/usr/bin/env python3
"""Read back Google Play monetization product states for AnswerGuard."""
...
from scripts.play_monetization_client import (
    PACKAGE,
    REQUIRED_BUSINESS_ANNUAL_BASE_PLAN_ID,
    REQUIRED_FAMILY_ANNUAL_BASE_PLAN_ID,
    REQUIRED_ONE_TIME,
...
def main() -> int:
    ...
    report = {
        ...
        "required_family_annual_base_plan_id": REQUIRED_FAMILY_ANNUAL_BASE_PLAN_ID,
        "required_business_annual_base_plan_id": REQUIRED_BUSINESS_ANNUAL_BASE_PLAN_ID,
        "status": (
            "ok"
