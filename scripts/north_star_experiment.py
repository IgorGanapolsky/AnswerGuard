...
def build_experiment_brief(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "proof_commands": [
            ...
            "cd native-ios && xcodebuild test -project AnswerGuard.xcodeproj -scheme AnswerGuard -destination 'platform=iOS Simulator,id=<SIMULATOR_ID>' -skip-testing:AnswerGuardUITests -quiet CODE_SIGNING_ALLOWED=NO",
        ],
