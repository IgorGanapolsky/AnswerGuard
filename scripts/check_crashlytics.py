...
Setup (one-time in Firebase Console):
    ...
    2. This enables streaming export to: answerguard-486213.firebase_crashlytics.{app_id}

Requires:
    - gcloud auth (or GOOGLE_APPLICATION_CREDENTIALS)
    - BigQuery API enabled on answerguard-486213
    - Firebase project: answerguard-486213
"""
...
def query_crash_summary(token, hours):
    ...
    # For com.igorganapolsky.answerguard -> com_iganapolsky_answerguard
