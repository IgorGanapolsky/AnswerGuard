...
FIRST_POST_TOPIC = "The inspiration behind AnswerGuard"
...
def build_post_copy(
    ...
    title = topic
    description = (
        "A short engineering update on how we ship AnswerGuard faster with automation, "
    ...
    if inspiration_url:
        inspiration_block = (
            "## Inspiration\n"
            "The core idea for AnswerGuard came from training principles in **Hard Target**:\n"
            f"{inspiration_url}\n\n"
    ...
    sections.extend(
        [
            ...
            "- What does AnswerGuard do? It triggers alarms at unpredictable times in a chosen range.\n"
...
def render_paperbanana_svg(spec: Dict[str, Any], output_path: Path) -> None:
    ...
    lines.append(
        "<text x=\"74\" y=\"710\" font-family=\"Avenir Next,Segoe UI,Arial,sans-serif\" font-size=\"21\" fill=\"#C4E4F9\">AnswerGuard growth system: measurable, testable, automated.</text>"
    )
...
def build_site(output_root: Path) -> Dict[str, Any]:
    ...
    for md_path in sorted(posts_src.glob("*.md"), reverse=True):
        ...
        post_html = textwrap.dedent(
            ...
            <head>
              ...
              <title>{html.escape(title)} | AnswerGuard Blog</title>
              <meta name="description" content="{html.escape(description)}" />
              <meta name="robots" content="index,follow,max-image-preview:large" />
              <link rel="canonical" href="{html.escape(canonical_url)}" />
              <meta property="og:type" content="article" />
              <meta property="og:site_name" content="AnswerGuard Engineering Blog" />
    ...
    index_structured_json = json.dumps(
        {
            "@context": "https://schema.org",
            "@type": "Blog",
            "name": "AnswerGuard Engineering Blog",
    ...
    index_html = textwrap.dedent(
        ...
        <head>
          <meta charset="utf-8" />
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <title>AnswerGuard Engineering Blog</title>
          ...
          <meta property="og:site_name" content="AnswerGuard Engineering Blog" />
          <meta property="og:title" content="AnswerGuard Engineering Blog" />
          ...
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content="AnswerGuard Engineering Blog" />
        ...
        <body>
          <main class="container">
            <h1>AnswerGuard Engineering Blog</h1>
...
def generate_post(args: argparse.Namespace) -> PostAsset:
    ...
    play_store_url = os.getenv(
        "PLAY_STORE_URL",
        "https://play.google.com/store/apps/details?id=com.igorganapolsky.answerguard",
    )
    ...
    android_review_url = os.getenv(
        "ANDROID_REVIEW_URL",
        "https://play.google.com/store/apps/details?id=com.igorganapolsky.answerguard&reviewId=0",
    )
