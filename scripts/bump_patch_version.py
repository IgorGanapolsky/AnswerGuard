...
IOS_PBXPROJ = REPO_ROOT / "native-ios" / "AnswerGuard.xcodeproj" / "project.pbxproj"
...
def _build_changelog_message(base_message: str | None) -> str:
    ...
    return f"AnswerGuard update — {month_year}"
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--changelog-message",
        default=None,
        help='Override the default "AnswerGuard update — Month YYYY" message.',
    )
    parser.add_argument(
        "--skip-changelog",
        action="store_true",
