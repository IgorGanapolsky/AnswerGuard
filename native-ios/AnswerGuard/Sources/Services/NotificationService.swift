...
final class NotificationService: NSObject, TimerNotificationHandling {
    ...
    func activateMediaSession() {
        ...
        MPNowPlayingInfoCenter.default().nowPlayingInfo = [
            MPMediaItemPropertyTitle: "AnswerGuard - Alarm",
            MPMediaItemPropertyArtist: "AnswerGuard"
        ]
    }
    ...
    func scheduleReengagementReminder() {
        ...
        content72.body = "Fighters train when they don't feel like it. Open AnswerGuard."
