...
public struct TimerActivityAttributes: ActivityAttributes {
    ...
    public init(timerName: String = "AnswerGuard", endDate: Date, minSeconds: Int = 30, maxSeconds: Int = 120) {
...
public let timerAppGroupSuite = "group.com.igorganapolsky.answerguard"
